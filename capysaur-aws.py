...
pygame.display.set_caption("Capysaur AWS Game")
...
class Capy(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.running_sprites.append(pygame.transform.scale(pygame.image.load(resource_path("capy/capy1.png")),(74,50)))
        self.running_sprites.append(pygame.transform.scale(pygame.image.load(resource_path("capy/capy2.png")),(74,50)))
...
class Cloud(pygame.sprite.Sprite):
    def __init__(self, x, y, speed):
        super().__init__()
        original_image = pygame.image.load(resource_path("capy/cloud-aws.png")).convert_alpha()
...
#Ground
ground = pygame.image.load(resource_path("capy/groundfinal-aws.png"))
...
#Logo
logo = pygame.image.load(resource_path("capy/AWS Logo.png")).convert_alpha()
...
while True:
    ...
    if not game_active :
        ...
        screen.blit(ground, (ground_x, ground_rect.top))
        screen.blit(ground, (ground_x + 1280, ground_rect.top))
        logo_rect = logo.get_rect(topright=(1280 - 20, 20))
